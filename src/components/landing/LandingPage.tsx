    ...
    <div className="space-y-20">
      ...
      <section className="text-center py-16 space-y-6">
        ...
        <h1 className="text-5xl font-bold text-text leading-tight max-w-3xl mx-auto">
          ...
          <span className="text-primary">que crece con la comunidad</span>
        </h1>
        ...
        <div className="flex items-center justify-center gap-4">
          <Link
            href="/buscar"
            className="bg-primary text-white px-6 py-3 rounded-xl font-medium hover:bg-primary-h transition-colors flex items-center gap-2"
          >
            Explorar currículos
      ...
      <section className="bg-surface rounded-2xl border border-border p-8 md:p-12">
        <div className="flex flex-col md:flex-row items-start md:items-center gap-8">
          <div className="bg-primary/5 p-4 rounded-2xl shrink-0">
            <GitCommit className="w-10 h-10 text-primary" />
          </div>
      ...
      <section className="text-center py-12">
        ...
        <Link
          href="/login"
          className="bg-primary text-white px-8 py-4 rounded-xl font-semibold text-lg hover:bg-primary-h transition-colors inline-flex items-center gap-2"
        >
