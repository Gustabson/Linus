        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center gap-6">
              ...
              <Link href="/explorar?tipo=kernel" className="text-gray-600 hover:text-gray-900 text-sm font-medium flex items-center gap-1">
          ...
          {open && (
            <div className="md:hidden py-3 border-t border-gray-100 space-y-2">
              ...
              <Link href="/explorar?tipo=kernel" className="block px-2 py-1 text-gray-700" onClick={() => setOpen(false)}>Kernels</Link>
              {session ? (
                <>
                  {needsUsername && (
