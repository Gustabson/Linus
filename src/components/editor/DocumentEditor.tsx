  ...
  return (
    <div className="space-y-3">
      ...
      {sections.length === 0 && !showAdd && (
        <div className="bg-surface rounded-2xl border-2 border-dashed border-border p-12 text-center space-y-4">
          <div className="w-14 h-14 rounded-2xl bg-bg border border-border flex items-center justify-center mx-auto">
            <LayoutList className="w-7 h-7 text-gray-300" />
          </div>
          <div>
            <p className="font-semibold text-text">Este documento no tiene secciones</p>
      ...
      {showAdd && isOwner && (
        <form
          ...
          className="bg-surface rounded-2xl border-2 border-dashed border-gray-300 p-5 space-y-4"
        >
          ...
          <input
            ...
            className="w-full border border-border rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-gray-400 focus:ring-2 focus:ring-gray-100 transition-all"
          />
      ...
      {isOwner && sections.length > 0 && !showAdd && (
        <button
          onClick={() => setShowAdd(true)}
          className="w-full flex items-center justify-center gap-2.5 text-sm text-text-subtle hover:text-text border-2 border-dashed border-border hover:border-gray-300 hover:bg-bg rounded-2xl py-4 transition-all group"
        >
          <div className="w-6 h-6 rounded-lg bg-border-subtle group-hover:bg-border flex items-center justify-center transition-colors">
