...
function GitHubIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 text-text">
...
const PROVIDER_META: Record<string, { label: string; icon: React.ReactNode }> = {
  ...
  credentials: { label: "Correo y contraseña", icon: <span className="text-xs">✉</span> },
};
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        {emailVerified
          ? <Badge variant="green"><ShieldCheck className="w-3.5 h-3.5" /> Verificado</Badge>
          : <Badge variant="amber">Sin verificar</Badge>
        }
      </div>
      ...
      <div className="space-y-2">
        ...
        <div className="flex flex-wrap gap-2">
          {providers.map(p => {
            ...
            return (
              <Badge key={p} variant="gray" className="py-1.5">
